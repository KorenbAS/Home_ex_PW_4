...
class KorFramework(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        clent_socket.sendto(data, (SOCKET_HOST, SOCKET_PORT))
        clent_socket.close()
...
def save_data_from_form(data):
    ...
    try:
        message_info = {key: value for key, value in [
    ...
    messages[message_datetime] = message_info
    try:
...
def run_http_server(host, port):
    address = (host, port)
    http_server = HTTPServer(address, KorFramework)
